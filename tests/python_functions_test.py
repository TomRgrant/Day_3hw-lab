...
class TestPythonFunctionPractice(unittest.TestCase):
  ...
  def test_volume_of_cube(self):
    calculated_volume_of_cube = volume_of_cube(5)
    self.assertEqual(125, calculated_volume_of_cube)
    pass

  #Given a String, return the String reversed
  def test_reverse_string(self):
    reversed_string = reverse_string("Tom")
    self.assertEqual("moT", reversed_string)
    pass

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius(self):
    converted_temp = fahrenheit_to_celsius(87)
    self.assertEqual(31, converted_temp)
    pass
